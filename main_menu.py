...
class MainMenu:
    ...
    def about(self, _=None):
        ...
        txt += '- Left clicks to add landmarks\n'
        txt += '- Ctrl+N to add connections\n'
        txt += '- Right clicks to add slide positions\n'
        txt += '- Ctrl+Backspace to remove the last slide position\n'
        txt += '- Ctrl+S to save the configuration\n'
        txt += '- Ctrl+E to export slides\n'
        txt += '\nhttps://github.com/skliff13/DCS_KneeboardMaker\n'
